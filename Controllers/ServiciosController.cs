...
using MiPrimerProyectoMVC.DBContext;
...
namespace MiPrimerProyectoMVC.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdServicio,Descripcion,Valor")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdServicio,Descripcion,Valor")] Servicio servicio)
        {
